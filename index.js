...
// Example usage
console.log(updateEmployeeWithKeyAndValue(employee, "streetAddress", "456 Elm St")); // Non-destructive
console.log(employee); // Original stays the same

console.log(destructivelyUpdateEmployeeWithKeyAndValue(employee, "streetAddress", "789 Oak St")); // Destructive
